        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="POST" class="d-flex">
                    <input type="password" class="form-control border-success me-3" id="exampleInputPassword1" placeholder="Votre Mot de passe" name="password">
                    <button type="submit" class="btn btn-success" name="logadmine">Connexion</button>
                </form>
            </div>
        </div>
    </div>
