                    ...
                    <div class="mt-4">
                        <form method="POST">
                            <div class="mb-3 d-flex">
                                <input type="text" class="form-control border-primary" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Votre nom" name="nom">
                                <input type="email" class="form-control border-primary ms-2" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Votre adresse e-mail" name="email">
                            </div>
                            <div class="mb-4 d-flex">
                                ...
                                <input type="password" class="form-control border-primary ms-2" id="exampleInputPassword1" placeholder="Confirmer le mot de passe" name="rpassword">
                            </div>
                            <div class="d-flex justify-content-between align-items-center ">
                                <button type="submit" class="btn btn-primary text-white col-5" name="create">Inscription</button>
                            </div>
                        </form>
                    </div>
                </div>
    ...
    <div class="carousel-inner">
        <div class="carousel-item active">
            ...
            <div class="carousel-caption d-none d-md-block d-flex flex-column justify-content-center align-items-center text-white" style="bottom: 330px !important;">
                ...
                <button type=" button " class="btn text-white fw-bold fs-5 px-5 border border-white" data-toggle="modal" data-target="#clientexampleModalCenter" style="background-color: #FF8D29;">Réserver Maintenant</button>
            </div>
        </div>
    </div>
</section>
...
<!-- START LES CARDS -->
<section class="container-fluid bg-black" id="reservation">
...
<section style="background-color: #E9E9E9;" id="propos">
...
<!-- START CONTACT NOUS -->
<section class="container-fluid row d-flex justify-content-end align-items-center" id="contact">
    <div class="col-5">
