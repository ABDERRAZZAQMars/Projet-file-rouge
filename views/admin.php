  ...
  <div class="col-2 d-flex flex-column justify-content-between bg-dark" style="height: 100vh;">
    <div class="mt-3">
      <div class="border-bottom d-flex justify-content-center mb-3">
        <img src="./views/assets/img/logoWhite.png" class="py-2" width="150" alt="">
      </div>
      <div>
    ...
    <div class="border-top mb-4">
      <a href="home" class="btn btn-outline-secondary mt-2 text-white text-decoration-none fs-6 w-100"><i class="bi bi-box-arrow-in-right me-2"></i>Déconcerter</a>
    </div>
  </div>
