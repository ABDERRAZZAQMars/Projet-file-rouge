                                        ...
                                        <?php foreach ($data['reservation'] as $row) { ?>
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td class="btn btn-danger btn-valider" type="button" data-bs-toggle="modal" data-bs-target="#validerModal" style="background-color: black;">valider</td>
                ...
                <form action="<?php echo URLROOT; ?>/Transportcontroller/add" method="POST">
                    <div class="container d-flex flex-column">
                        ...
                        <div class="d-flex justify-content-between align-items-center ">
                            <button type="submit" class="btn btn-success text-white my-2 mx-auto" name="submit">Ajouter Transport</button>
                        </div>
                    </div>
                </form>
            </div>
