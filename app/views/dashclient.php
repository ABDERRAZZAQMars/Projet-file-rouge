    ...
    <div class="modal-dialog">
        <div class="modal-content text-center">
            ...
            <form action="<?php echo URLROOT; ?>/Reservationcontroller/reserver" method="POST">
                <input type="text" name="trport_id" class="trport_id">
                <input type="text" name="trport_matricule" class="trport_matricule">
                <input type="text" name="trport_genre" class="trport_genre">

                <input type="text" name="trteur_id" class="trteur_id">
                <input type="text" name="client_nom" value="<?php echo $_SESSION['nom'] ?>">
                <input type="text" name="client_email" value="<?php echo $_SESSION['email'] ?>">
                ...
                <input type="text" name="validation" value="En attente">
                <div class="px-4 py-3">
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav ms-auto me-2 mb-2 mb-lg-0 mt-2">
                    <li class="nav-item"><a href="" class="btn btn-dark text-white text-decoration-none fs-6 w-100"><i class="bi bi-bag-fill me-2"></i>Transport</a></li>
                    <li class="nav-item"><a href="" class="btn btn btn-dark text-white text-decoration-none fs-6 w-100 me-5"><i class="bi bi-bag-fill me-2"></i>Commandes</a></li>
                                ...
                                <?php foreach ($data['transport'] as $row) { ?>
                                    <tbody>
                                        <tr>
                                            ...
                                            <td class="btn btn-danger btn-delete" type="button" data-bs-toggle="modal" data-bs-target="#reserverModal" style="background-color: black;">Réserver</td>
                                        </tr>
                                    </tbody>
                                <?php } ?>
                            <?php } else { ?>
