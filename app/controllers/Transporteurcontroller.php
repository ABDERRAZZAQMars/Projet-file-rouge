...
class Transporteurcontroller extends Controller
{
    ...
    {
        $this->transporteurModel = $this->model('Transporteurmodels');
    }
    ...
    public function register()
    {
        ...
        if ($_SERVER['REQUEST_METHOD'] == 'POST') {
            ...
            if (empty($data['email'])) {
                ...
                if ($this->transporteurModel->findAdminByEmail($data['email'])) {
    ...
    public function login()
    {
        ...
        if ($_SERVER['REQUEST_METHOD'] == 'POST') {
            ...
            if (empty($data['email'])) {
                ...
                if ($this->transporteurModel->findAdminByEmail($data['name'])) {
            ...
            if (empty($data['emailError']) && empty($data['passwordError'])) {
                $loggedInAdmin = $this->transporteurModel->login($data['email'], $data['password']);
